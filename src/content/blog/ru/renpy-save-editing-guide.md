...
О: В настоящее время наш редактор предоставляет **только просмотр** сохранений Ren'Py. Поддержка полного редактирования недоступна из-за рисков безопасности десериализации pickle.

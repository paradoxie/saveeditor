...
description: "GameMaker Studio のセーブ編集ガイド。Undertale や Deltarune で使われる INI/JSON の場所、主要フィールド、変更手順、破損を避ける確認方法を説明します。"
pubDate: 2026-01-02
...
統一されたセーブシステムを持つエンジンとは異なり、GameMakerは開発者にデータ保存方法の完全な自由を与えています。そのためセーブ形式は様々ですが、多くは当エディタが安定対応するいくつかの共通カテゴリに分類されます。
